...
dataset_type = 'SYSUCD_Dataset'
data_root = "D:/CDDataset/SYSU-CD"
...
param_scheduler = [
    dict(
        type='LinearLR', start_factor=1e-6, by_epoch=True, begin=0, end=10, convert_to_iter_based=True),
    dict(
        type='PolyLR',
        power=1.0,
        begin=10,
